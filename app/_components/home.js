    ...
    <div className="h-screen bg-pages" id="home">
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-1">
        ...
        <span className="text-[1rem] font-mono">Hi I'm Max Bryan Bauzon,</span>
          <span className="gradient text-[3rem]">A Software Engineer</span> by profession with 4+ years of work experience based in the <div className="gradient text-[5rem]">Philippines.</div>
        </div>
        </div>
